...
'Call SetWindowPos API function
  ...
  Text4.Text = "My Settings are:" & vbCrLf & "MyWidth = (Screen.Width / 4)" & vbCrLf & "MyHeight = Screen.Height / 4" & vbCrLf & "MyLeft = Screen.Width / (50 * Screen.TwipsPerPixelX)" & vbCrLf & "MyTop = Screen.Height / (2 * Screen.TwipsPerPixelY)"
End Sub
